...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=mypackage.Memory_Unit" json:"unit,omitempty"`
}
...
var file_proto_memory_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x6d, 0x79, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x22,
	0xaa, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61,
	...
	0x2e, 0x6d, 0x79, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_proto_memory_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: mypackage.Memory.Unit
	(*Memory)(nil),   // 1: mypackage.Memory
}
var file_proto_memory_proto_depIdxs = []int32{
	0, // 0: mypackage.Memory.unit:type_name -> mypackage.Memory.Unit
